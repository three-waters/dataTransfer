...
public class StoreHouseServiceImpl extends BaseServiceImpl implements StoreHouseService {
	...
	public void execute(String lkbh) {
		System.out.println("开始进行============仓房信息============数据转换");
		System.out.println("----开始====删除粮库编号为" + lkbh + "的仓房信息");
		toCwlwJdbcTemplate.execute("delete from cwlw_storehouse where LKBH = '" + lkbh + "'");
		System.out.println("----结束====删除粮库编号为" + lkbh + "的仓房信息");
		System.out.println("----开始====获取源库仓房信息");
		...
		System.out.println("----结束====获取源库仓房信息");
		System.out.println("----开始====获取源库电缆信息");
		...
		System.out.println("----结束====获取源库电缆信息");
		System.out.println("----开始====转换仓房信息");
		...
		System.out.println("----结束====转换仓房信息");
		System.out.println("----开始====生成仓房信息SQL");
		List<String> insertSQL = SQLUtil.toInsertSQL(toResult, "cwlw_storehouse");
		System.out.println("----结束====生成仓房信息SQL");
		System.out.println("----开始====插入仓房信息");
		toCwlwJdbcTemplate.batchUpdate(insertSQL.toArray(new String[insertSQL.size()]));
		System.out.println("----结束====插入仓房信息");
		System.out.println("结束进行============仓房信息============数据转换,源表条数：" + sourceStoreHouseResult.size()
